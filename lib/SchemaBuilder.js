...
class SchemaBuilder {
  ...
  _resolverForModel(modelData, extraQuery, customQuery = false) {
    return (ctx, ignore1, ignore2, data) => {
      ...
      const argFilter = this._filterForArgs(ast, modelClass, data.variableValues, customQuery);
  ...
  _filterForArgs(astNode, modelClass, variableValues, customQuery) {
